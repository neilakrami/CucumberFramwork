...
//	String BaseURI = RestAssured.baseURI = "http://18.232.148.34/syntaxapi/api";
	...
	//	request = apiMethods.createEmployeeRequest(GenerateTokenSteps.token, APIPayloadCommanMethods.createEmployeeBody());
		/**
		 * The Payload MUST be a String bellow line of code is doing the same as above
		 */
	}
	...
	@Then("the status code retrieving the created employee is {int}")
	public void the_status_code_retrieving_the_created_employee_is(int statusCodeForRetrievingEmployee) {
	...
	public void the_retrieved_employee_ID_matches_the_globally_stored_employee_ID(String retroevedEmployeeID) {
		response.then().assertThat().body(retroevedEmployeeID, equalTo(employeeID));
	}
	...
	public void a_request_is_prepared_to_retieve_all_employees() {
	...
	@Then("the satus code for retrieving all employees is {int}")
	public void the_satus_code_for_retrieving_all_employees_is(Integer int1) {
	...
	@Then("the retrieved dat matches the data that was used to created an employee")
		public void the_retrieved_data_matches_the_data_that_was_used_to_created_an_employee() {
