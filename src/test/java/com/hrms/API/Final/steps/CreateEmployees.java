...
import com.hrms.utils.APIPayloadCommanMethods;
...
public class CreateEmployees {
	...
	public void employee_data_provided_is(String employeeFirstName, String employeeLastName,
		...
		request = APICommonMethods.createEmployeeRequest(GenerateTokenSteps.token,
				APIPayloadCommanMethods.createEmployeePayloadMoreDynamic
				(employeeFirstName, employeeLastName,
				employeeMiddleName, employeeGender, 
				employeeBirthday, employeeJobStatus, 
				employeeJobTitle));
	}
